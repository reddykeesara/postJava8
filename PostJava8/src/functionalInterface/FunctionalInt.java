...
interface Fintf {
	...
	int hashCode();//even though we add this it is still a FI bcos hashcode is a method of Object
	
	default void display() {
		System.out.println("in Fintf display");
	}
...
class DemoImpl extends Demo implements Fintf  {

	@Override
	public void show() {
		System.out.println("inside demoimpl show");

	}
//	public void display() {
//		System.out.println("inside DemoImpl display");
//	}
